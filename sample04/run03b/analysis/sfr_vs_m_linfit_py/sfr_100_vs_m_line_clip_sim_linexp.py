...
THIS VERSION FOR 2015-05-16-A/sample04/run03  lin-exp SFH FITS.
...
if __name__ == '__main__':        
    ...
    *fits done without covariance. (2) is the best fit 
    ...
    SFR-M* non-outliers	0.57281	-1.64097
    Age < 0.1 Gyr	0.541167	-1.4791
    Age >  0.2 Gyr	0.53208	-1.72345
    ...
    Below parameters correspond to all non-outliers subsample of sample00,
    ...
    """  
    """
    No measure of intrinsic scatter in run04, so use
    total scatter as upper limit
    """
    ...
    text_label_scatter =r"$\sigma_{is} < 0.204$"    
