...
THIS VERSION FOR 2015-05-16-A/sample04/run03b  lin-exp SFH FITS.
...
v10 11/10/2015  Add selection functions computed in ...Manuscripts/2015/
...
v11 2/4/2016    4 mass bins for residuals instead of three
"""
...
if __name__ == '__main__':        
    ...
    *fits done without covariance. (2) is the best fit 
    ...
    axis5.set_ylabel(r"Log SFR, $M_\odot$ yr$^{-1}$", fontsize = 12)
    ...
    a_whitaker2014 = 0.91
    b_whitaker2014 = 1.62
    log_mass_lower_limit_whitaker2014 = 9.3
    ...
    """
    """
    Do not plot in sample04 because Whitaker+2014 does not cover this
    redshift range
    """
    """
    ...
    All	      0.749478	-7.38227
    Age < 0.1 Gyr		
    Age > 1.0 Gyr		
    EBV > 0.5		
    EBV < 0.1		
    		
    Table 2b.  log F435W vs logSFR		
    		
    Description	       Slope, a	Intercept, b
    SFR-M* non-outliers	0.54192	-1.58869
    ...
    x_selection_function = np.linspace(5.0,8.2,10000)  
    ...
    eg. x_bins = np.array([1.0, 8.0, 9.0, 20.0])
        where   bin1 = [1.0, 8.0]
                ...
                bin4 = [10.0,20.0]
    """
    x_bins = np.array([1.0, 8.0, 9.0, 10.0, 20.0])
    ...
    if (args.verbose):
        ...
        print("\nBin 4")
        print("\tNumber of data in bin          : ", y_binscat_bin4.size)
