...
THIS VERSION FOR 2015-05-16-A/sample00/run03b  lin-exp SFH FITS.
...
v11 02/03/2016  Added another mass bin in residuals.
"""
...
if __name__ == '__main__':        
    ...
    *fits done without covariance. (2) is the best fit 
    ...
    Table 1.  sample01 log F160W vs logMass sample01		
    ...
    Table 2b.  sample00 log F435W vs logSFR (Inst)		
    		
    Description	      Slope, a	Intercept, b
    Good Correlation	0.51	       -0.52
