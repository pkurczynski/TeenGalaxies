...
if __name__ == '__main__':        
    ...
    Covariance_LogStellarMass_LogSFR = tbData.field('Cov_5_6')
    Variance_LogStellarMass = tbData.field('Cov_5_5')
    Variance_LogSFR = tbData.field('Cov_6_6')

    Chisq_BestFit = tbData.field('Chisq_BestFit')

    Correlation_LogStellarMass_LogSFR = tbData.field('Corr_5_6')
    ...
    """
    Identify outliers from initial fit.
    
    Outliers are determined by threshold "sigma" value input argument
    """    
    """
    original method of clipping
    """
    """    
    outlierThreshold_sigma = float(args.clip_sigma)
    outliers = ((y_rescaled_initialfit_residual_sigma > outlierThreshold_sigma) | (y_rescaled_initialfit_residual_sigma < -1*outlierThreshold_sigma))
    nonoutliers = ((y_rescaled_initialfit_residual_sigma < outlierThreshold_sigma) & (y_rescaled_initialfit_residual_sigma > -1*outlierThreshold_sigma))

    outliers_positive = ((y_rescaled_initialfit_residual_sigma > outlierThreshold_sigma))
    outliers_negative = ((y_rescaled_initialfit_residual_sigma < -1*outlierThreshold_sigma))
    ...
    k07_rescaled_refit_cov_slope = 0.8402
    k07_rescaled_refit_cov_slope_error = 0.0150
    
    k07_rescaled_refit_intercept = 0.1000
    k07_rescaled_refit_intercept_error = 0.0117
    
    k07_rescaled_refit_cov_intercept = 0.0976
    k07_rescaled_refit_cov_intercept_error = 0.0116
    
    k07_rescaled_refit_scatter_variance = 0.0573
    k07_rescaled_refit_scatter_variance_error = 0.0052

    k07_rescaled_refit_cov_scatter_variance = 0.0552
    k07_rescaled_refit_cov_scatter_variance_error = 0.0052
