#!/usr/bin/env python
"""
sfr_100_vs_m_line_clip_sim.py                       Python3 script
...
example:  bash$ 
./sfr_100_vs_m_line_clip_sim.py -v -i 1000 -c 3.0 -z 1.2 2014-11-13-A__sample01__run04__speedymc_results.fits sfr_100_vs_m_line_clip_sim_z12.pdf > sfr_100_vs_m_line_clip_sim_z12.log.txt
...
if __name__ == '__main__':        
    ...
    if (args.verbose):
        print("sfr_100_vs_m_line_clip_sim.py \n")
    ...
    Covariance_LogStellarMass_LogSFR = tbData.field('Cov_5_8')
    Variance_LogStellarMass = tbData.field('Cov_5_5')
    Variance_LogSFR = tbData.field('Cov_8_8')

    Chisq_BestFit = tbData.field('Chisq_BestFit')
    
    Correlation_LogStellarMass_LogSFR = tbData.field('Corr_5_8')
    ...
    k07_rescaled_refit_cov_slope = 0.9739
    k07_rescaled_refit_cov_slope_error = 0.0143
    
    k07_rescaled_refit_intercept = 0.0761
    k07_rescaled_refit_intercept_error = 0.0113
    
    k07_rescaled_refit_cov_intercept = 0.07738
    k07_rescaled_refit_cov_intercept_error = 0.0114
    
    k07_rescaled_refit_scatter_variance = 0.0586
    k07_rescaled_refit_scatter_variance_error = 0.0044

    k07_rescaled_refit_cov_scatter_variance = 0.0570
    k07_rescaled_refit_cov_scatter_variance_error = 0.0045
    ...
    if (args.verbose):
       ...
       np.savetxt(refit_data_table_id_cov_corr_theta_filename,
                  np.column_stack((source_id_refit,x_refit,sx_refit,y_refit,sy_refit,sx_refit**2, sy_refit**2, covxy_refit,corrxy_refit, sigxp2, sigyp2, theta)),
    ...
    if (args.verbose):  
        ...
        print("\nsfr_100_vs_m_line_clip_sim.py Done!")