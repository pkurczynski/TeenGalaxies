...
if __name__ == '__main__':        
    ...
    *fits done without covariance. (2) is the best fit 
    ...
    k07_rescaled_refit_cov_slope = 1.0498
    k07_rescaled_refit_cov_slope_error = 0.01172
    
    k07_rescaled_refit_intercept = 0.08114
    k07_rescaled_refit_intercept_error = 0.01000
    
    k07_rescaled_refit_cov_intercept = 0.09787
    k07_rescaled_refit_cov_intercept_error = 0.00922
    
    k07_rescaled_refit_scatter_variance = 0.0264
    k07_rescaled_refit_scatter_variance_error = 0.00259

    k07_rescaled_refit_cov_scatter_variance = 0.0228
    k07_rescaled_refit_cov_scatter_variance_error = 0.00245
