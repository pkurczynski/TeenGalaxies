...
if __name__ == '__main__':        
    ...
    *fits done without covariance. (2) is the best fit 
    ...
    a_whitaker2014 = 0.94
    b_whitaker2014 = 1.11
    log_mass_lower_limit_whitaker2014 = 8.5
    ...
    see file:  sample00_run03_f160w_vs_logmass_v1.pdf		
    Description	Slope, c	Intercept, d
    All	0.82857	-7.19539
    Age < 0.1 Gyr	0.73244	-6.1007
    Age > 1.0 Gyr	0.79374	-7.07034
    EBV > 0.5	0.64365	-5.51295
    EBV < 0.1	0.84159	-7.37167
    		
    Table 2.  log F435W vs logSFR		
    see file:  sample00_run03_f435w_vs_sfr_v2.pdf		
    Description	Slope, a	Intercept, b
    SFR-M* non-outliers	0.53045	-0.70935
    Age < 0.1 Gyr	0.53066	-0.73857
    Age >  1.0 Gyr	0.60904	-0.68318
    		
    		
    Table 3.  log F435W vs logSFR		
    see file:  sample00_run03_f435w_vs_sfr_v3.pdf		
    Description	Slope, a	Intercept, b
    SFR-M* non-outliers	0.53045	-0.70935
    EBV < 0.10	0.71282	-0.51505
    EBV > 0.50	0.37571	-1.11487

    Table 4.  Flux threshold
